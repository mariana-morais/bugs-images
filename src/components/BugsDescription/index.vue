  ...
  <section class="grid-section bugs" id="bugs">
    ...
    <div class="bugs-description tabcontent">
      ...
      <section>
        <h2>Bug's</h2>
        <p>
          Bugs and insects aren't necessarily the same thing. The two words are used interchangeably, with insects appearing mostly in scientific contexts and bugs being used more casually, but the difference between the terms comes down to more than just semantics. 
          They both describe groups in the animal kingdom recognized by science.
        </p>
        <p>
          All bugs are insects, but under the technical definition, not all insects are bugs. True bugs belong to an order of insects called Hemiptera. 
          There are a few characteristics that distinguish bugs from other insects: Most bugs have a straw-shaped mouth, or stylet, that they use to either sap juice from plants or blood from animals. 
          ...
          Confusingly, some insects with bug in their name aren't actually true bugs, like ladybugs and June bugs (they're both beetles).
        </p>
      </section>
      <section>
        <h2>Butterflie's</h2>
        ...
        <p>
          ...
          Some, like the monarch and the painted lady, migrate over long distances. Many butterflies are attacked by parasites or parasitoids, including wasps, protozoans, flies, and other invertebrates, or are preyed upon by other organisms. Some species are pests because in their larval stages they can damage domestic crops or trees; other species are agents of pollination of some plants. 
          Larvae of a few butterflies eat harmful insects, and a few are predators of ants, while others live as mutualists in association with ants. Culturally, butterflies are a popular motif in the visual and literary arts.
        </p>
      </section>
      <section>
        <h2>Grasshopper's</h2>
        <p>
          Grasshoppers are a group of insects belonging to the suborder Caelifera. They are among what is probably the most ancient living group of chewing herbivorous insects, 
          dating back to the early Triassic around 250 million years ago.
          Grasshoppers are typically ground-dwelling insects with powerful hind legs which allow them to escape from threats by leaping vigorously. As hemimetabolous insects, they do not undergo complete metamorphosis; 
          they hatch from an egg into a nymph or "hopper" which undergoes five moults, becoming more similar to the adult insect at each developmental stage. 
        ...
        <p>
          ...
          Other species such as the rainbow grasshopper have warning coloration which deters predators. Grasshoppers are affected by parasites and various diseases, and many predatory creatures feed on both nymphs and adults. 
        </p>
      </section>
      <section>
        <h2>Ant's</h2>
